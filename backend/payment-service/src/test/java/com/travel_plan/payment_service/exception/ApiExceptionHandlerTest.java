...
class ApiExceptionHandlerTest {
    ...
    void handlesValidationErrorsAsBadRequest() {
        ...
        when(bindingResult.getFieldErrors())
                .thenReturn(List.of(new FieldError("paymentRequest", "amount", "must not be null")));
    ...
    @Test
    void handlesMissingRequestHeaderAsBadRequest() {
    ...
    @Test
    void handlesUpstreamCallFailureAsBadGateway() {
