...
class TravelServiceClientConfigTest {

    private final TravelServiceClientConfig config = new TravelServiceClientConfig();
    ...
    void skipsSslSetupWhenBundleNameIsBlank() {
        ...
        RestClient.Builder builder = config.loadBalancedRestClientBuilder("", sslBundlesProvider);
    ...
    void skipsSslContextWhenNoBundlesAvailable() {
        ...
        RestClient.Builder builder = config.loadBalancedRestClientBuilder("internal-services", sslBundlesProvider);
    ...
    @Test
    void travelServiceRestClientBuildsFromLoadBalancedBuilder() {
        RestClient.Builder builder = mock(RestClient.Builder.class);
        RestClient restClient = mock(RestClient.class);
        when(builder.baseUrl("http://travel-service")).thenReturn(builder);
        when(builder.build()).thenReturn(restClient);

        RestClient result = config.travelServiceRestClient(builder);
